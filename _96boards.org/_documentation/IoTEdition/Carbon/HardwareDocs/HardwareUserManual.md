...
permalink: /documentation/IoTEdition/Carbon/HardwareDocs/HardwareUserManual.md/
...
description: |-
    A user manual for the Carbon IoT Edition Board Hardware to help you get started with Carbons Hardware.
---
