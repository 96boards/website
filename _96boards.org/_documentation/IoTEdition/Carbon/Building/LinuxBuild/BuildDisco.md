...
page_title: 96Boards - How to build the disco Zephyr application from source
permalink: /documentation/IoTEdition/Carbon/Building/LinuxBuild/BuildDisco.md/
breadcrumb-page_title: How to build the disco Zephyr application from source
breadcrumb-section: Documentation
breadcrumb-section-two: IoT Edition
breadcrumb-section-three: Carbon
breadcrumb-subpage_title: Building for Linux - Disco
description: |-
