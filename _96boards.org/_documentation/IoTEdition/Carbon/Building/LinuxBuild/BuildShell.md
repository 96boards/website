...
page_title: 96Boards - How to build the Shell Zephyr application from source - Linux Host
permalink: /documentation/IoTEdition/Carbon/Building/LinuxBuild/BuildShell.md/
breadcrumb-page_title: How to build the Shell Zephyr application from source
breadcrumb-section: Documentation
breadcrumb-section-two: IoT Edition
breadcrumb-section-three: Carbon
breadcrumb-subpage_title: Building for Linux - Shell
description: |-
