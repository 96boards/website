...
page_title: MediaTekX20 Installing on Linux Host
description: |-
...
|:--------------------------------------|:-----------------------|:--------------------------------------------------------|
| MediaTekX20-aosp-16.10-image.tar.xz  | [Download](http://builds.96boards.org/releases/helio-x20-pro/mediatek/aosp/latest/MediaTekX20Pro-aosp-*-image.tar.xz) | This is an "Image only" tarball, here you will find all pre-built images needed for OS installation |
| MediaTekX20-aosp-16.10-source.tar.xz | [Download](http://builds.96boards.org/releases/helio-x20-pro/mediatek/aosp/latest/MediaTekX20Pro-aosp-*-code.tar.xz) | This download includes source files for building images |
