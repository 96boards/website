...
page_title: Hikey User Manual
permalink: /documentation/ConsumerEdition/Hikey/AdditionalDocs/UserManual.md/
breadcrumb-page_title: Hikey User Manual
breadcrumb-section: Documentation
breadcrumb-section-two: Consumer Edition
breadcrumb-section-three: Hikey
breadcrumb-section-four: Additional Docs
breadcrumb-subpage_title: User Manual
description: |-
    This is the usermanual for the HiKey board which is the first board to be certified 96Boards Consumer Edition compatible,
