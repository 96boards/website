...
page_title: DragonBoard-410c Installation - Linux
permalink: /documentation/ConsumerEdition/DragonBoard-410c/Installation/LinuxSD.md/
breadcrumb-page_title: DragonBoard-410c Installation on Linux
...
description: |-
    Installing an operating system on the DragonBoard-410c Consumer Edition Board.
---
## Linux Host
...
- Unzipped folder should be called DragonBoard-410c_sdcard_install_Y-XX, where Y can be Android of Debian and XX represents the release number
