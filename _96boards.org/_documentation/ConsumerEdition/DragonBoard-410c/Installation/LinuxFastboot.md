...
page_title: DragonBoard-410c Installation - Fastboot Linux
permalink: /documentation/ConsumerEdition/DragonBoard-410c/Installation/LinuxFastboot.md/
breadcrumb-page_title: DragonBoard-410c Linux Fastboot Method
breadcrumb-section: Documentation
breadcrumb-section-two: Consumer Edition
breadcrumb-section-three: DragonBoard-410c
breadcrumb-section-four: Installation
breadcrumb-subpage_title: DragonBoard-410c Linux Fastboot Method
description: |-
...
- The bootloader file should be named `DragonBoard-410c_bootloader_emmc_Y-XX`
...
#Example:
cd DragonBoard-410c_bootloader_emmc_linux-40
#<unzipped Bootloader folder> = DragonBoard-410c_bootloader_emmc_linux-40
