...
As good as it sounds it is not truly compatible with all of the [96Boards](https//www.96boards.org/products/ce/). In fact, at the time of writing this blog, it can only be used with the [Dragonboard 410c](https//www.96boards.org/product/dragonboard410c/).
