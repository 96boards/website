...
Connecting to the wrong I2C pins often causes the device to hang at the [Wait for Slave Ack](https://github.com/zephyrproject-rtos/zephyr/blob/master/drivers/i2c/i2c_ll_stm32_v1.c#L325) code as
