...
With that said, the support is still WIP, so no official builds are available. To get lakka running, you'll have to built it from source as described in our guide: [https://www.96boards.org/documentation/consumer/rock/build/lakka.md.html](https://www.96boards.org/documentation/consumer/rock/build/lakka/)
