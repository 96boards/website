...
description: Use OpenSCAD to create a 3D printed case for DragonBoard 410c.
  OpenSCAD is free software for creating solid 3D CAD objects and is available
  for Linux/UNIX, MS Windows, and Mac OS X.
images:
  - ./_images/3DPrintCase_FrontPage.png
  - ./_images/3DPrintCase_Image1.png
  - ./_images/3DPrintCase_Image2.png
  - ./_images/3DPrintCase_Image3.png
categories:
  - dragonboard410c
# image: ./images/3DPrintCase_FrontPage.png
image_name: 3dprintcase-thumb.png
image_thumb: 3dprintcase-thumb.png
slug: 3dprintcase/
---
