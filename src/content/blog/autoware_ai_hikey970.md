...
and load the default config as per step 5 in [here](https://gitlab.com/autowarefoundation/autoware.ai/autoware/wikis/ROSBAG-Demo#steps). 2. Laptop -> Terminal 2
