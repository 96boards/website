...
**This week**, we will be meeting with **Al Falk (https://www.instagram.com/falkyou/)** who is a web application developer, cybersecurity MS candidate and model from Pittsburgh! Falkyou's STEM story is unique and very empowering, filled with challenges and game changers as she found her way into the tech industry. It is our pleasure to introduce Al as this week's #WomeninSTEM guest to be featured on OpenHours for the month of May livestream interview series! Don't forget to tune in at the end of the countdown.
